...
;
        ...
        {
            return ((regions[0].State == 1 && regions[1].State == 1 && regions[2].State == 1) ||(regions[0].State == -1 && regions[1].State == -1 && regions[2].State == -1)) ? regions[0].State : 0;
        }
        ...
        public static void Update(Region[] regions)
        {
            ...
            if (whoWon == 1)
            {
                PlayerWhoWon = "P1 Wins"; CanKeepPlaying = false;
            }

            if (whoWon == -1)
            {
                PlayerWhoWon = "P2 Wins"; CanKeepPlaying = false;
            }
        }
    }
}
